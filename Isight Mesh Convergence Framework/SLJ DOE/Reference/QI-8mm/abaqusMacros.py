...
def Pin_Loading_Model():
    ...
    DIAMETER = int(8.0)
    HOLE_ELEM_NUM = int(6.0)
    LAYUP_J = [int(0.0), int(45.0), int(90.0), int(-45.0), int(-45.0), int(90.0), int(45.0), int(0.0)]
    ...
    # STEP-1
    mdb.models['Model-1'].StaticStep(name='Step-1', previous='Initial', maxNumInc=10000000, initialInc=0.01, minInc=1e-5)
...
def Failure_Analysis():
    ...
    odb = openOdb(path="C:\Users\s1232851\Desktop\Mesh_convergence\Reference\Chang_and_Scott_Basic\QI-8mm\Job-1.odb")
